...
func (in *BackendNamespaces) DeepCopyInto(out *BackendNamespaces) {
	*out = *in
	if in.From != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendNamespaces.
func (in *BackendNamespaces) DeepCopy() *BackendNamespaces {
	if in == nil {
		return nil
	}
	out := new(BackendNamespaces)
	in.DeepCopyInto(out)
	return out
}
