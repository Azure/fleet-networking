...
func (in *BringYourOwn) DeepCopyInto(out *BringYourOwn) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BringYourOwn.
func (in *BringYourOwn) DeepCopy() *BringYourOwn {
	if in == nil {
		return nil
	}
	out := new(BringYourOwn)
	in.DeepCopyInto(out)
	return out
}
