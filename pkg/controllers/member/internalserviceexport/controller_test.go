...
func TestObserveMetrics(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			wantMetricCount: 1,
			wantHistogram: `
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="1000"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="2500"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="5000"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="10000"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="25000"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="50000"} 1
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="+Inf"} 1
				fleet_networking_service_export_duration_milliseconds_sum{originClusterID="bravelion"} 1000
				fleet_networking_service_export_duration_milliseconds_count{originClusterID="bravelion"} 1
			`,
		},
		{
			...
			wantMetricCount: 1,
			wantHistogram: `
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="1000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="2500"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="5000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="10000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="25000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="50000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="+Inf"} 2
				fleet_networking_service_export_duration_milliseconds_sum{originClusterID="bravelion"} 2000
				fleet_networking_service_export_duration_milliseconds_count{originClusterID="bravelion"} 2
			`,
		},
		{
			...
			wantHistogram: `
				...
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="25000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="50000"} 2
				fleet_networking_service_export_duration_milliseconds_bucket{originClusterID="bravelion",le="+Inf"} 3
				fleet_networking_service_export_duration_milliseconds_sum{originClusterID="bravelion"} 102000
				fleet_networking_service_export_duration_milliseconds_count{originClusterID="bravelion"} 3
			`,
		},
	}
